...
#
# Usage ./run_ANI_contigs.sh sample_name   DB(for looking up reference, just relative path, also is genus)   Species   run_ID  list_samples_to_include(optional)
#
...
mashtree --numcpus ${procs} *.fasta --tempdir ${OUTDATADIR}/Contig_check/ANI/temp > ${OUTDATADIR}/Contig_check/ANI/"${genus_in}_and_${1}_mashtree_ANIm_contigs.dnd";
