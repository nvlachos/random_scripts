...
counter=0
max_subs=${2}
main_dir="${share}/kraken_subs"
main_dir="${share}/mass_subs/kraken_subs"
if [[ ! -d "${share}/mass_subs/kraken_subs" ]]; then
	mkdir "${share}/mass_subs/kraken_subs"
	mkdir "${share}/mass_subs/kraken_subs/complete"
elif [[ ! -d  "${share}/mass_subs/kraken_subs/complete" ]]; then
	mkdir "${share}/mass_subs/kraken_subs/complete"
fi
