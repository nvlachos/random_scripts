	...
	if [[ -s "${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed.fasta" ]]; then
		...
		if [[ ${counter} -lt ${max_subs} ]]; then
			...
			if [[ ! -f "${processed}/${project}/${sample}/prokka/${sample}_PROKKA.gbf" ]]; then
				...
				echo -e "mv ${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed.fasta ${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed_formatted.fasta" >> "${main_dir}/prok_${sample}_${start_time}.sh"
				echo -e "mv ${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed_original.fasta ${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed.fasta" >> "${main_dir}/prok_${sample}_${start_time}.sh"
				echo -e "python3 ${shareScript}/fasta_headers.py -i ${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed.fasta-backup -o ${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed.fasta --reverse" >> "${main_dir}/prok_${sample}_${start_time}.sh"
				echo -e "${shareScript}/run_prokka.sh ${sample} ${project}" >> "${main_dir}/prok_${sample}_${start_time}.sh"
				echo -e "mv ${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed.fasta ${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed_original.fasta" >> "${main_dir}/prok_${sample}_${start_time}.sh"
				echo -e "mv ${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed_formatted.fasta ${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed.fasta" >> "${main_dir}/prok_${sample}_${start_time}.sh"
			...
			do
				...
				if [[ -f "${main_dir}/complete/${waiting_sample}_prok_complete.txt" ]] || [[ ! -s "${processed}/${project}/${waiting_sample}/Assembly/${waiting_sample}_scaffolds_trimmed.fasta" ]]; then
					...
					if [[ ! -f "${processed}/${project}/${sample}/prokka/${sample}_PROKKA.gbf" ]]; then
						...
						echo -e "#$ -q short.q\n"  >> "${main_dir}/prok_${sample}_${start_time}.sh"
						echo -e "cd ${shareScript}" >> "${main_dir}/prok_${sample}_${start_time}.sh"
						echo -e "mv ${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed.fasta ${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed.fasta-backup" >> "${main_dir}/prok_${sample}_${start_time}.sh"
						echo -e "python3 ${shareScript}/fasta_headers.py -i ${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed.fasta-backup -o ${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed.fasta --reverse" >> "${main_dir}/prok_${sample}_${start_time}.sh"
						echo -e "${shareScript}/run_prokka.sh ${sample} ${project}" >> "${main_dir}/prok_${sample}_${start_time}.sh"
						echo -e "rm ${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed.fasta" >> "${main_dir}/prok_${sample}_${start_time}.sh"
						echo -e "mv ${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed.fasta-backup ${processed}/${project}/${sample}/Assembly/${sample}_scaffolds_trimmed.fasta" >> "${main_dir}/prok_${sample}_${start_time}.sh"
						echo -e "echo \"$(date)\" > ${main_dir}/complete/${sample}_prok_complete.txt" >> "${main_dir}/prok_${sample}_${start_time}.sh"
						cd "${main_dir}"
						qsub "${main_dir}/prok_${sample}_${start_time}.sh"
