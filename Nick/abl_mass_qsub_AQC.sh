...
counter=0
max_subs=${2}
main_dir="${share}/mass_subs/ACS_subs"
if [[ ! -d "${share}/mass_subs/ACS_subs" ]]; then
	mkdir "${share}/mass_subs/ACS_subs"
	mkdir "${share}/mass_subs/ACS_subs/complete"
elif [[ ! -d "${share}/mass_subs/ACS_subs/complete" ]]; then
	mkdir "${share}/mass_subs/ACS_subs/complete"
fi
